...
        correct_answers_list = data.get('correct_answers', []) # قائمة الإجابات الصحيحة (فارغة إذا كان نموذجاً)
...
            prompt_task = f"""
                ...
                التركيز يجب أن يكون على منطقة الإجابات فقط.
                يرجى الرد بقائمة JSON تحتوي على إجابة واحدة لكل سؤال من {num_questions} سؤال.
                استخدم القيمة "Blank" (باستثناء مسح نموذج الإجابة) أو إحدى القيم: {options_str}.
            """
        else:
